 ...
 * Every other error passes through unchanged — already redacted by
 * `GlitchTipClient`, whose `extraSecrets` `CallOptions` the caller uses for
 * anything besides the token that must not reach the agent (BUG-20260925-017).
 */
