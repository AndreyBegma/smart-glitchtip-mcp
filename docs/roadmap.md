...
| BUG-20260925-017 | Partial reads overwrite GlitchTip data (projects, releases); token prefix leaks through the 500-char detail cut | BUG-006 | [BUG-20260925-017-partial-read-writes-and-truncated-token](https://github.com/AndreyBegma/smart-glitchtip-mcp/blob/develop/docs/specs/BUG-20260925-017-partial-read-writes-and-truncated-token.md) | token-safety | any | READY |
